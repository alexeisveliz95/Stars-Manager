...
def generate_visual_prompt(tweet_content):
    ...
    estilos = {
        "schematic": "2D minimalist technical schematic, engineering grid, precise lines.",
        "blueprint": "Industrial blueprint style, cyanotype blue background, thick white drafting lines.",
        "cybernetic": "Neon-circuit style, glowing electric cyan accents, dark obsidian background.",
        "abstract": "Abstract data flow, interconnected nodes, particle trails, high-tech elegance."
    }

    system_prompt = (
        "You are a master of technical drafting and minimalist digital art. "
        "Select the most appropriate style from the following list based on the user's content: "
        f"{list(estilos.keys())}. "
        ...
        "\nINSTRUCTIONS: "
        "1. Start with the style description.[cite: 2] "
        "2. Add: 'flat vector style, sharp lines, isometric but no perspective distortion'.[cite: 2] "
        "3. NO text, NO people, NO realistic lighting, NO shadows.[cite: 2]"
    )
