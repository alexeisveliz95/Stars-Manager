...
| :--- | :--- | :--- | :--- |
| **uptime-kuma** | ⭐ 86,084 | A fancy self-hosted monitoring tool | [🔗](https://github.com/louislam/uptime-kuma) |
| **n8n-workflows** | ⭐ 54,052 | all of the workflows of n8n i could find (also from the site itself) | [🔗](https://github.com/Zie619/n8n-workflows) |
| **pyautogui** | ⭐ 12,464 | A cross-platform GUI automation Python module for human beings. Used to programmatically control the mouse & keyboard. | [🔗](https://github.com/asweigart/pyautogui) |
